...
export default class OrderRepositoryDatabase implements OrderRepository {
  ...
  async get(code: string): Promise<Order> {
    ...
    for (const orderItemData of orderItemsData) {
      ...
      const item = new Item(itemData.id_item, itemData.category, itemData.description, parseFloat(itemData.price), itemData.height, itemData.width, itemData.length, itemData.weight);
